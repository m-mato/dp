...
váh jednotlivých položiek znázorňuje nasledujúca schéma
\ref{fig:footprint-distance-cal}.
...
Kľúčovú rolu pri výpočte teda zohráva kalibrácia váh a parametrov tohto
...
algorithm get-distance is
    ...
    # AttributesIndex based on SUM of weighted attributes
    # is computed. Additional weight for all attributes 
    # will be applied.
    attributesIndex 
    ...
    # Final similarity value is computed as sum of weighted:
    # staticHeaders, unknownHeaders and attributes. Distance 
    # as 1 - sim value is returned
    similarity 
