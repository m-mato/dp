...
\begin{figure}[h]
  \centering
    \includegraphics[width=.80\textwidth]{images/tech-app.png}
...
\section{Zhrnutie}
Na identifikáciu užívateľa, prípadne jeho zariadenia je možné sú v súčasnosti
používané rôzne techniky na rôznych vrstvách sieťovej infraštruktúry. Od IP
adries sieťovej vrstvy cez atribút TCP protokolu až po komplexné aplikačné
identifikátory.
