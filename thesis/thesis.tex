...
\thesissetup{
    ...
    keywords      = {identifikácia, HTTP, TCP, podobnosť, hľadanie podobnosti, DOS, rozpoznanie užívateľa},
    TeXkeywords   = {identifikácia, HTTP, TCP, podobnosť, hľadanie podobnosti, DOS, rozpoznanie užívateľa},
    assignment  = {} %TODO - prnted - Kopie zadání a Kopie prohlášení autora školního díla
}

\thesislong{abstract}{
Táto práca sa zaoberá prieskumom možností rozpoznania užívateľa na základe dostupných
informácií z HTTP, prípadne TCP protokolu a tvorbou unikátneho identifikátoru.
...
Súčasťou práce je zhodnotenie existujúcich prístupov identifikácie a praktická časť, ktorá
...
\section{Podobné a súvisiace práce}
...
informácie HTTP protokolu. Ide o práce s tematikou prispôsobenia obsahu a
profilovania užívateľov na základe jeho verejne dostupných dát. Nasledujúce sekcie 
preto stručne popisujú dve najvýstižnejšie vybrané práce, ktoré sa venujú tejto problematike.

\subsection{Prispôsobenie obsahu}
Provu prácou je článok s názvom \textit{Automatic personalization based on Web usage mining} \cite{Mobasher:2000:APB},
...
Pre zlepšenie identifikácie používateľa preto táto práca narába s~atribútmi HTTP protokolu a~zostavuje
tak zoznam navštívených webov pre účely prispôsobenia obsahu.
...
Okrem štandardných informácií z komunikácie s klientom však táto práca popisuje aj 
...
rozdeliť do skupín a konkrétnu reklamu cieliť len na vybrané skupiny ich vzoriek.
...
algorithm get_nearest_neigbour is
    ...
    for each stockUFooEntity in allStockItems do
        ...
        # Relation Data analysis - can afffect distance 
...
Ďalej už s reprezentáciami \textit{HTTPFootprint} a \textit{TCPFootprint} [\ref{fig:appendix-structure}]
...
pomerne malá diverzita obsahu HTTP hlavičiek. Jednotlivé varianty hlavičiek sa lýšili
